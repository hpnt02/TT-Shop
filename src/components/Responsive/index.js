...
export const MobileAndTabletLarge = ({ children }) => {
    const isResponsive = useMediaQuery({ maxWidth: 1119 });
    return isResponsive ? children : null;
};

export const TabletSmallAndDestopLarge = ({ children }) => {
    const isResponsive = useMediaQuery({ minWidth: 576 });
    return isResponsive ? children : null;
};
